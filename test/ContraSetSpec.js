describe("ContraSet", function() {
    ...
    it("knows what group a dancer belongs to after two progressions", function () {
        expect(contraSet.getGroupAndPos(0, 34)).toEqual([0, 2]);
        expect(contraSet.getGroupAndPos(1, 34)).toEqual([0, 3]);
        expect(contraSet.getGroupAndPos(2, 34)).toEqual([1, 2]);
        expect(contraSet.getGroupAndPos(3, 34)).toEqual([1, 3]);
        expect(contraSet.getGroupAndPos(4, 34)).toEqual([0, 0]);
        expect(contraSet.getGroupAndPos(5, 34)).toEqual([0, 1]);
        expect(contraSet.getGroupAndPos(6, 34)).toEqual([1, 0]);
        expect(contraSet.getGroupAndPos(7, 34)).toEqual([1, 1]);
    });
